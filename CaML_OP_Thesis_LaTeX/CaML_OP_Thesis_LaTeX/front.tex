...
\bottomrule\noalign{}
\endlastfoot
\textbf{Matriculation number} & [TBD] \\
\textbf{Kind of thesis submitted} & Bachelor Thesis \\
\end{longtable}

\textbf{English: Declaration of Authorship}

We hereby declare that the thesis submitted was created and written solely by ourselves without

any external support. Any sources, direct or indirect, are marked as such. We are aware
...
plagiarism. We do agree our work to be entered into a database for it to be compared with
...
Wir erkl ¨aren hiermit, dass die vorliegende Arbeit ohne fremde Hilfe ausschließlich von

uns erstellt und geschrieben worden ist. Jedwede verwendeten Quellen, direkter oder

indirekter Art, sind als solche kenntlich gemacht worden. Uns ist die Tatsache bewusst,

dass der Inhalt der Thesis in digitaler Form gepr ¨uft werden kann im Hinblick darauf, ob es

sich ganz oder in Teilen um ein Plagiat handelt. Wir sind damit einverstanden, dass unsere
...
First and foremost, we want to express our sincere gratitude to our supervisor, Ishansh Gupta, for his invaluable guidance and technical feedback throughout the development of CaML-OP. His patience through the countless iterations of this pipeline truly shaped the final form of this work.

We are equally grateful to our co-supervisor, Prof. Dr. Hendro Wicaksono, for his oversight of the academic process and his sharp, constructive criticism of the regulatory framing.

Our thanks also go to the faculty and staff at the School of Computer Science and Engineering at Constructor University for providing the academic environment that made this thesis possible.

Finally, we gratefully acknowledge The Cancer Genome Atlas (TCGA) Research Network and the National Cancer Institute for making the TCGA-OV dataset publicly available. This work would also not be possible without the incredible open-source communities behind EconML, XGBoost, scikit-learn, lifelines, and the broader Python scientific ecosystem.
